...
### load phosphosites related data
data("KinaseMotifs")
data("KinaseFamily")
...
setwd("F:/Masterarbeit_BioWis/people/Mita/R analysis/")

norm_abundance2 <- read.table("norm_abundance_inter.txt", sep="\t", header=TRUE, dec=".")
