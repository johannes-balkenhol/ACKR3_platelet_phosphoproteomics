...
KSData = read.csv("/Users/ozgeosmanoglu/Nextcloud/Phosphoproteom/phosphoproteom validation/analysis/KSEA/PSP&NetworKIN_Kinase_Substrate_Dataset_July2016.csv")
