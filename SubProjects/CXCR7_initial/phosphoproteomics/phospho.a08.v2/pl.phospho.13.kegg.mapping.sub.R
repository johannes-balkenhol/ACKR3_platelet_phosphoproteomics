...
colnames(df)<-c("uniprot","name", "t10","t30","t60","t300","t600","t900","t1800")
...
colnames(gene_list_uniprot)<-c("t10","t30","t60","t300","t600","t900","t1800")
...
## sort the list in decreasing order (required for clusterProfiler)
colnames(gene_list_name)<-c("t10","t30","t60","t300","t600","t900","t1800")
...
#platelet activation
hsa04611 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04611",
                     species    = "hsa",
...
hsa04151 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04151",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
#mtor
hsa04150 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04150",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
#calcium signaling
hsa04020 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04020",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
hsa05418 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa05418",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
hsa04010 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04010",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
hsa04810 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04810",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
hsa04152 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04152",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
#Apoptosis
hsa04210 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04210",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
hsa04610 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04610",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
hsa00590 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa00590",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
...
# cAMP signaling
hsa04024 <- pathview(gene.data  = gene_list_entrez[,c(1:7)],
                     pathway.id = "hsa04024",
                     species    = "hsa",
                     limit      = list(gene=max(abs(gene_list_entrez))),
                     gene.idtype="entrez",
