...
### go to script folder
setwd("C:/Users/Ozge/Nextcloud/Phosphoproteom/phosphoproteom validation") ##ÖO folder structure
#setwd("D:/Eigene Datein/Phosphoproteom/phosphoproteom validation/scripts/")
setwd("F:/Masterarbeit_BioWis/Phosphoproteomics/Phosphoproteom validation") ## JB Laptop privat
setwd("C:/Users/job37yv/Research/Phospho/Phospho A08")  ## JB Laptop RVZ
