...
##or
original_gene_list <- Tc$top.10
names(original_gene_list) <- sapply(strsplit(rownames(Tc), ";"), "[[", 2)
...
ridgeplot(gseR,  showCategory = 30,core_enrichment = TRUE,orderBy = "p.adjust", label_format = 30, decreasing = TRUE)
