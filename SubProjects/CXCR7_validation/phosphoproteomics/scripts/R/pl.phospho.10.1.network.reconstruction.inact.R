...
library(SparkR)       # For handling large datasets if needed
...
### 1. collpase by uniprot, choose row with max(abs(logFC))
...
### 2. with phoscollpase with seem to be faily
